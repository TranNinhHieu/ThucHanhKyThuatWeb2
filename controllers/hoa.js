	...
	for(i=0;i<dshoa.length;i++)
	 {
			   ...
			   kq=kq+"<tr>";
			   kq=kq+"<td><img src='/images/"+dshoa[i].hinh+"'></td><td>Tên hoa :"+dshoa[i].tenhoa +"<br>Giá bán :"+dshoa[i].dongia+"<br>Mô Tả :"+dshoa[i].mota+"<br><a href='/"+dshoa[i].maloai+"'>Về Trang Chủ</a></td>";
